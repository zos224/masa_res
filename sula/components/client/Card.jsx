            ...
            <div className="md:w-1/2 w-full min-h-180 bg-black-2 relative">
                ...
                <div className="top-0 left-0 right-0 bottom-0 absolute z-10 border border-primary-color m-5 text-center ">
                    <div className="absolute top-1/2 -translate-y-1/2 ">
                        ...
                        <div className="font-gambarino lg:text-4xl text-2xl  uppercase font-normal text-white text-center lg:mt-10 mt-3">{subtitle}</div>
                        <Image className="text-primary-color m-auto mt-7 lg:w-50 w-30" src="/images/bg/decor_color.svg" alt="line" width={200} height={50} />
                        <div className="font-jost lg:text-2xl text-xl text-white text-center xl:px-20 px-3 my-10">{description}</div>
                        <Link href={link} className="border-2 border-white text-white uppercase hover:border-none hover:text-primary-color hover:font-bold px-5 py-3 ">{buttonText} &nbsp; &nbsp; &nbsp;&gt; </Link>
                    </div>
                </div>
            </div>
        </div>
