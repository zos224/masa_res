          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <Image className="w-5 h-5" src={"/images/icon/restaurant.svg"} width={50} height={50}></Image>
                  Restaurant
                </Link>
              </li>
              {/* <!-- Menu Item Restaurant --> */}
              ...
              <li>
                ...
                >
                  <Image className="w-5 h-5" src={"/images/icon/menu.svg"} width={50} height={50}></Image>
                  Menu
                </Link>
              </li>
              {/* <!-- Menu Item Menu --> */}
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <Image src={"/images/icon/product.svg"} width={50} height={50} className="w-5 h-5"></Image>
                        Product
                        <svg
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/admin/product/product-option"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/product/product-option" &&
                                "text-white"
                              }`}
                            >
                              Product Option
                          ...
                          <li>
                            <Link
                              href="/admin/product/product-customization"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/product/product-customization" &&
                                "text-white"
                              } `}
                            >
              ...
              {/* <!-- Menu Item Order --> */}
               ...
               <SidebarLinkGroup
                activeCondition={
                  pathname === "/reservation" || pathname.includes("reservation")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/reservation/table" &&
                                "text-white"
                              }`}
                            >
                              Table Reservation
                          ...
                          <li>
                            <Link
                              href="/admin/reservation/group"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/reservation/group" &&
                                "text-white"
                              }`}
                            >
                              Group Reservation
                          ...
                          <li>
                            <Link
                              href="/admin/reservation/buyout"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/admin/reservation/buyout" &&
                                "text-white"
                              } `}
                            >
                              Buy Out
