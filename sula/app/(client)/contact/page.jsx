    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="py-10 text-center">
                ...
                <div className="mt-10">
                    <Link className="border-2 px-7 py-3 text-lg rounded-md border-primary-color text-primary-color hover:bg-primary-color hover:text-white font-semibold" href={"/contact/feedback"}>Feedback</Link>
                </div>
            </div>
        </div>
    )
