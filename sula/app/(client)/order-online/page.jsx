  ...
  return (
    <div>
        <div className="relative">
            ...
            <span className="absolute text-4xl text-center font-cambria bg-dark-custom lg:px-20 py-2 px-5 font-bold text-white top-1/2 sm:left-1/2 sm:-translate-x-1/2">
              Order Online
            </span>
        </div>
        <div className="pt-10 bg-image4"> 
            ...
            <div className="text-center mt-10">
                ...
                <div className="mt-10">
                    <span className="text-black font-medium text-3xl font-cambria">MINIMUM ORDER</span>
            ...
            <div className="mx-auto text-center mt-20">
                <p className="text-2xl font-cambria text-black tracking-widest">DISTANCE CALCULATOR & DIRECTIONS FOR PICK UP</p>
            ...
            <div className="mt-10">
                <p className="w-3/5 text-center m-auto text-2xl font-cambria text-black tracking-widest">MASALA LOYALTY CARD: ONE CARD LINKED TO ALL YOUR ORDERS! BECOME A PART OF MASALA FAMILY WITH OVER 18,000 LOYALTY MEMBERS</p>
            </div>
        </div>
    </div>
  );
